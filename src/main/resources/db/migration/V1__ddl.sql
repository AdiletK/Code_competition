...
create table option (id int8 not null, is_correct boolean, option varchar(255), task_id int8, primary key (id));
...
create table participant_answer (id int8 not null, option varchar(255), participant_id int8, task_id int8, primary key (id));
...
alter table answer add constraint FK8yia55x5xhg4o5a8jxdj9ws8b foreign key (task_id) references "task";
...
alter table option add constraint FKggf14hq10t57h2ht50aidubny foreign key (task_id) references "task";
...
alter table source_code add constraint FKcvjwi76f9bojhne7l4epp0a1x foreign key (task_id) references "task";
alter table "task" add constraint FKfp0l0y4gf60v88krmvhij5pfr foreign key (competition_id) references competition;
alter table test add constraint FK15q7e6m34oweb54my8yboe9hf foreign key (source_code_id) references source_code;
