...
public class DataInitializer implements CommandLineRunner {
    ...
    public DataInitializer(RoleRepo roleRepo, UserRepo userRepo, SubjectRepo subjectRepo, CompetitionRepo competitionRepo, TaskRepo taskRepo, SourceCodeRepo sourceCodeRepo, TestRepo testRepo) {
    ...
    public void run(String... args) {
        ...
        sourceCodeRepo.save(new SourceCode(1L, 100F,100F,taskRepo.getOne(1L)));

        Arrays.asList(
                new Test(1L, "1 2", "3", sourceCodeRepo.getOne(1L)),
                new Test(1L, "2 2", "4", sourceCodeRepo.getOne(1L))
        ).forEach(this.testRepo::saveAndFlush);
